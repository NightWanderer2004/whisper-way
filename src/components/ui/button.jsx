   ...
   'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-stone-950 disabled:pointer-events-none disabled:opacity-50',
   {
      variants: {
         variant: {
            ...
            'skeuo-white':
               'skeuo-white shadow-[0_1px_5px_-1.8px_rgba(0,0,0,12%)] overflow-hidden relative bg-whiteBg text-black font-normal lowercase border-2 border-white/10 rounded-[16px]',
            'skeuo-mini':
               'skeuo-white bg-white/95 border-white/30 shadow-smooth text-textColor font-normal lowercase border-2 border-white/10 rounded-[16px]',
         },
         size: {
            ...
            'skeuo-white': 'px-[18px] py-[4px] font-normal font-lexend text-[18px] text-textAccent/65 transition-all duration-700 ease-gentle',
